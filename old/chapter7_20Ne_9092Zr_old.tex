...
The dashed line in Fig.\ref{fig7.1}(a) shows the barrier distribution
obtained with a
...
\end{eqnarray}
or, in terms of the coupling matrix, we require
\begin{eqnarray}
...
\begin{figure}[h]
  ...
  \hspace{0.5cm}
  \begin{minipage}[t]{78mm}
    \includegraphics[clip,keepaspectratio,width=78mm]{figure/chapter7/qel_20Ne_92Zr_150deg_noncoll_w0_200.pdf}
...
\begin{figure}[t]
  \center
  \includegraphics[clip,keepaspectratio,width=100mm]{figure/chapter7/qel_20Ne_92Zr_150deg_noncoll_w0_200_scaled.pdf}
...
\begin{figure}[h]
  ...
  \begin{minipage}[t]{79mm}
    \includegraphics[clip,keepaspectratio,width=79mm]{figure/chapter7/qel_20Ne_92Zr_150deg_convergence2.pdf}
    \caption{Convergence of the coupled-channels calculation for $^{20}$Ne +
    $^{92}$Zr
    with respect to the truncation of excited states of
    $^{92}$Zr. The energy truncation is changed from 3.0 MeV to 4.8 MeV. The
    red dashed and the blue solid lines are the same as in Fig.\ref{fig7.10}.}
    \label{fig7.13}
  \end{minipage}
\end{figure}
We first show the results obtained by
including 45 noncollective levels both in $^{90}$Zr and $^{92}$Zr nuclei.
Inclusion of 45 noncollective levels corresponds to
taking into account excited states up to 6.7 MeV for $^{90}$Zr and 4.0 MeV for
$^{92}$Zr.
...
\begin{figure}[t]
  \center
  \includegraphics[clip,keepaspectratio,width=100mm]{figure/chapter7/qel_20Ne_92Zr_150deg_convergence_average.pdf}
...
the convergence is already obtained if one includes 25 levels for $^{90}$Zr
nucleus.
In Fig.\ref{fig7.13}, we show the calculation for $^{20}$Ne + $^{92}$Zr system
with several truncations of the noncollective excitations ranging from 3.0 MeV to 4.8
...
that the convergence is obtained if one includes the excited states up to 4.0 MeV.
...
\begin{figure}[t]
  \center
    \includegraphics[clip,keepaspectratio,width=120mm]{figure/chapter7/Qval_dist_92Zr_w0_200.eps}
...
\begin{figure}[t]
  \center
    \includegraphics[clip,keepaspectratio,width=120mm]{figure/chapter7/Qval_dist_9092Zr_w0_200.eps}
...
\begin{figure}[t]
  \center
    \includegraphics[clip,keepaspectratio,width=150mm]{figure/chapter7/Qval_dist_energy_dep_92Zr_w0_200.pdf}
