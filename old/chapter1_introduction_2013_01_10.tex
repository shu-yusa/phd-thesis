...
Therefore, heavy-ion reactions around the Coulomb barrier provides us with
...
was studied in detail by Caldeira and Leggett\cite{CL81,CL83}.
...
In coupled-channels calculations, conventionally,
...
excitations in deformed nuclei, as well as few nucleon-transfer channels have 
been taken into account.
This is because, among the internal excited states,
these collective states strongly couple to the relative motion and play an
important role.
...
and quasi-elastic cross sections.
...
derivative of the ratio of the quasi-elastic cross section to the Rutherford
...
effects\cite{dasgupta,L95,BT98}. They
can also serve for the determination of deformation parameters\cite{LRL93}.

Although the coupled-channels method has been successfully accounted for various
experimental data for heavy-ion fusion reactions, as well as quasi-elastic
scattering, there is a long-standing problem of the approach, that is, in order
...
It has been also a long-standing problem that the coupled-channels calculation has not been able to
simultaneously reproduce the fusion and quasi-elastic barrier distributions for $^{16}$O +
$^{144}$Sm system\cite{zamrun}.

\begin{figure}[t]
  \begin{center}
    \begin{minipage}[t]{73mm} 
    \includegraphics[clip,keepaspectratio,width=73mm]{figure/chapter7/qel_bar_dist_20Ne_9092Zr.eps}
    ...
    \begin{minipage}[t]{75mm}
      \includegraphics[clip,keepaspectratio,width=75mm]{figure/chapter7/Zr_spectra.eps}
...
\begin{figure}[t]
\center
    \includegraphics[clip,keepaspectratio,width=90mm]{figure/chapter6/Qdist_16O_208Pb.eps}
...
Furthermore, several recently obtained data cannot be accounted for by the
...
Although the excitation to each noncollective state is week compared to that to a collective
...
However, the coupled-channels calculation overestimates
...
noncollective excitations in barrier distributions and Q-value distributions.
...
system\cite{YHR12}. Since the coupled-channels calculation has not successfully reproduced
the fusion barrier distribution for this system\cite{MBD99},
we shall see whether the noncollective excitations can improve the agreement
...
experimental data is not improved for the fusion barrier distribution,
the energy dependence of the calculated 
...
We show the fusion calculations for $^{32}$S + $^{208}$Pb and
...
for $^{20}$Ne + $^{92}$Zr system leading to a much better agreement with the data.
On the other hand, for $^{20}$Ne + $^{90}$Zr system, the
noncollective excitations do not
change the structure of the barrier distribution in a significant way
and the agreement with the data is not destroyed by the 
noncollective excitations.
This difference between the two systems 
comes from the difference in the spectra of $^{90,92}$Zr
nuclei, thus we successfully achieve the simultaneous description of the
quasi-elastic barrier distributions for the $^{20}$Ne + $^{90,92}$Zr systems.
