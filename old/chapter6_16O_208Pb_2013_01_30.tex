...
\begin{figure}[t]
  \center
    \includegraphics[clip,keepaspectratio,width=85mm]{figure/chapter6/fusion_16O_208Pb.eps}
...
radius parameter $r_0 = R_{\rm T} 208^{-1/3} = 1.06$ fm.
As one can see, the peak for the $3^-$ channel is enhanced at energies
$E_{\rm c.m.}$ = 71.41, and 73.28 MeV and, as a consequence, consistent with
the data.
For the noncollective excitations,
we can see that some amount of the contribution between
$E^{*} \approx$ 3.5 MeV to 6 MeV is accounted for by this calculation,
while it still underestimates the data by about an order of magnitude.
Thus, although our calculation does not quantitatively reproduce the
data, it qualitatively agrees with the experiments.
\begin{figure}[t]
    \includegraphics[clip,keepaspectratio,width=160mm]{figure/chapter6/Qval_dist_comp_with_exp_beta3_0122.pdf}
...
\begin{figure}[t]
    \includegraphics[clip,keepaspectratio,width=160mm]{figure/chapter6/Qval_dist_comp_with_exp_betaN_0161_2.pdf}
