...
the peak structure is smeared. On the other hand, there is only a minor effect
of the noncollective excitations for $^{20}$Ne + $^{90}$Zr system.
As a consequence, the calculations simultaneously reproduce the experimental
...
above at barrier energies and see the energy dependence.

In order to see the effect of the noncollective excitations of $^{92}$Zr on
other reactions, we investigated $^{16}$O + $^{92}$Zr and $^{28}$Si systems.
...
That is, our calculation indicates a similar smearing effect for $^{24}$Mg +
...
In this thesis,
we have investigated the role of noncollective excitations in heavy-ion
reactions for specific systems.
We have seen that noncollective excitations often smear the barrier
distribution.
Our results show that in some systems, the effect of the noncollective excitations
